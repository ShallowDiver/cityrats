...
(function () {
  ...
  // OpenStreetMap standard tiles are light; the CSS filter on the tile pane
  // (see style.css) inverts them into a muted dark basemap so the heat ramp
  // still reads. No API key needed. maxZoom 19 is the top of OSM's tile set.
